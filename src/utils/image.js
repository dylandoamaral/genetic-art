import * as extUtils from './externe'
 ...
 * @returns {Image}
 */
export function scaleImage(image, ratio){
    let scaled = image;
 ...
 * @returns {ImageData}
 */
export function scaleImageData(imageData, ratio){
 ...
 * @returns {Image}
 */
export function maxSizeImage(image, max){
 ...
 * @returns {ImageData}
 */
export function maxSizeImageData(imageData, max){
 ...
 * @returns {ImageData}
 */
export function setPixel(imageData, x, y, v){
 ...
 * @returns {Array}
 */
export function getAllPixels(imageData){
    var pixels = [];
 ...
 * @returns {Array}
 */
export function getAllUniquePixels(imageData){
    return extUtils.multiDimensionalUnique(getAllPixels(imageData));
}
 ...
 * @returns {number}
 */
export function similarityBtwImageData(left, right, strict = false, strictThreshold = 50){
    let difference = 0;
 ...
 * @returns {ImageData}
 */
export function reverseHorizontalyImageData(imageData){
    let changed = imageData;
 ...
 * @returns {ImageData}
 */
export function reverseVerticalyImageData(imageData){
    let changed = imageData;
